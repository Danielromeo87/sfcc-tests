...
const I18N = {
    es: {
        ...
        footerAttribution: 'Con el fin de refrescar conceptos de cara a una entrevista de trabajo, esta web ha sido creada haciendo <em>vibe coding</em> y utilizando el modelo <strong>MiniMax - M3</strong>.<br>Autor: <strong>danielromeo87</strong>. Co-autoría técnica: <strong>MiniMax-M3</strong>.',
    ...
    en: {
        ...
        footerAttribution: 'This website was created as a personal <em>vibe coding</em> project using <strong>MiniMax - M3</strong>. Author: <strong>danielromeo87</strong>. Technical co-author: <strong>MiniMax-M3</strong>.',
